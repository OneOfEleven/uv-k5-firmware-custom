...
const uint8_t g_font_big[95][15] =
{
	...
	{0x80, 0xC0, 0x40, 0xC0, 0x80, 0xC0, 0x40, 0x00,  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}   // ~
#else
	{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},  // ' '
...
const uint8_t g_font_small[95][6] =
{
	...
	const uint8_t g_font_small_bold[95][6] =
	{
		...
		{0x64, 0x66, 0x7F, 0x7F, 0x60, 0x60},   // '1'
		{0x62, 0x73, 0x7B, 0x7B, 0x6F, 0x66},   // '2'
		{0x63, 0x63, 0x6B, 0x6B, 0x7F, 0x36},   // '3'
		{0x38, 0x3C, 0x36, 0x7F, 0x7F, 0x30},   // '4'
		{0x6F, 0x6F, 0x6B, 0x6B, 0x7B, 0x33},   // '5'
		{0x3E, 0x7F, 0x6B, 0x6B, 0x7B, 0x32},   // '6'
		{0x03, 0x03, 0x73, 0x7B, 0x0F, 0x07},   // '7'
		{0x36, 0x7F, 0x6B, 0x6B, 0x7F, 0x36},   // '8'
		{0x06, 0x6F, 0x6B, 0x6B, 0x7F, 0x3E},   // '9'
		{0x00, 0x00, 0x6C, 0x6C, 0x00, 0x00},   // ':'
		{0x00, 0x40, 0x6C, 0x2C, 0x00, 0x00},   // ';'
		{0x08, 0x14, 0x22, 0x41, 0x00, 0x00},   // '<'
		...
		{0x7E, 0x7F, 0x1B, 0x1B, 0x7F, 0x7E},   // 'A'
		{0x7F, 0x7F, 0x6B, 0x6B, 0x7F, 0x36},   // 'B'
		{0x3E, 0x7F, 0x63, 0x63, 0x77, 0x36},   // 'C'
		{0x7F, 0x7F, 0x63, 0x63, 0x7F, 0x3E},   // 'D'
		{0x7F, 0x7F, 0x6B, 0x6B, 0x6B, 0x63},   // 'E'
		{0x7F, 0x7F, 0x1B, 0x1B, 0x1B, 0x03},   // 'F'
		{0x3E, 0x7F, 0x63, 0x6B, 0x7B, 0x3A},   // 'G'
		{0x7F, 0x7F, 0x0C, 0x0C, 0x7F, 0x7F},   // 'H'
		{0x63, 0x63, 0x7F, 0x7F, 0x63, 0x63},   // 'I'
		{0x30, 0x73, 0x63, 0x7F, 0x3F, 0x03},   // 'J'
		...
		{0x7F, 0x7F, 0x1B, 0x1B, 0x1F, 0x0E},   // 'P'
		{0x3E, 0x7F, 0x63, 0x73, 0x7F, 0x7E},   // 'Q'
		{0x7F, 0x7F, 0x1B, 0x3B, 0x7F, 0x66},   // 'R'
		...
		{0x60, 0x60, 0x60, 0x60, 0x60, 0x60},   // '_'
		{0x00, 0x03, 0x07, 0x06, 0x00, 0x00},   // '`'
		{0x38, 0x7C, 0x6C, 0x6C, 0x7C, 0x7C},   // 'a'
		{0x7F, 0x7F, 0x6C, 0x6C, 0x7C, 0x38},   // 'b'
		{0x38, 0x7C, 0x6C, 0x6C, 0x6C, 0x00},   // 'c'
		{0x38, 0x7C, 0x6C, 0x6C, 0x7F, 0x7F},   // 'd'
		{0x38, 0x7C, 0x54, 0x54, 0x5C, 0x08},   // 'e'
		{0x7E, 0x7F, 0x1B, 0x1B, 0x03, 0x00},   // 'f'
		{0x08, 0x5C, 0x54, 0x54, 0x7C, 0x3C},   // 'g'
		{0x7F, 0x7F, 0x0C, 0x0C, 0x7C, 0x78},   // 'h'
		{0x00, 0x00, 0x74, 0x74, 0x00, 0x00},   // 'i'
		{0x30, 0x70, 0x60, 0x7D, 0x3D, 0x00},   // 'j'
		{0x7F, 0x7F, 0x18, 0x3C, 0x7E, 0x66},   // 'k'
		{0x00, 0x00, 0x3F, 0x7F, 0x60, 0x00},   // 'l'
		{0x7C, 0x7C, 0x18, 0x18, 0x7C, 0x7C},   // 'm'
		{0x7C, 0x7C, 0x0C, 0x0C, 0x7C, 0x78},   // 'n'
		{0x38, 0x7C, 0x6C, 0x6C, 0x7C, 0x38},   // 'o'
		{0x7C, 0x7E, 0x36, 0x36, 0x3E, 0x1C},   // 'p'
		{0x1C, 0x3E, 0x36, 0x7E, 0x7E, 0x60},   // 'q'
		{0x7C, 0x7C, 0x0C, 0x1C, 0x18, 0x00},   // 'r'
		{0x4C, 0x5E, 0x56, 0x56, 0x76, 0x20},   // 's'
		{0x3F, 0x7F, 0x6C, 0x6C, 0x60, 0x00},   // 't'
		{0x3C, 0x7C, 0x60, 0x60, 0x7C, 0x3C},   // 'u'
		{0x1C, 0x3C, 0x70, 0x70, 0x3C, 0x1C},   // 'v'
		{0x3C, 0x7C, 0x30, 0x30, 0x7C, 0x3C},   // 'w'
		{0x44, 0x6C, 0x38, 0x38, 0x6C, 0x44},   // 'x'
		{0x06, 0x6E, 0x6C, 0x6C, 0x7E, 0x3E},   // 'y'
		{0x64, 0x64, 0x54, 0x4C, 0x4C, 0x00},   // 'z'
		{0x08, 0x3E, 0x77, 0x41, 0x00, 0x00},   // '{'
		{0x00, 0x00, 0x7F, 0x00, 0x00, 0x00},   // '|'
		{0x00, 0x41, 0x77, 0x3E, 0x08, 0x00},   // '}'
		{0x18, 0x0C, 0x18, 0x30, 0x18, 0x00},   // '~'
	};
#endif
