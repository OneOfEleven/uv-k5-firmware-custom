...
enum key_code_e
{
	...
	KEY_SIDEPTT, // must be detected before key processing
};
...
extern uint8_t    g_side_ptt_debounce;
extern bool       g_side_ptt_is_pressed;
extern bool       g_side_ptt_was_released;
extern bool       g_side_ptt_was_pressed;
